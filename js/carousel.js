...
let carouselList = [
  { serial: '01', title: 'How to Play', desc: '#教程#', thumbnail: '', href: '' },
  { serial: '02', title: 'In-Game Items', desc: '#教程#', thumbnail: '', href: '' },
  { serial: '03', title: 'In-Game Items', desc: '#教程#', thumbnail: '', href: '' },
  { serial: '04', title: 'In-Game Items', desc: '#教程#', thumbnail: '', href: '' },
  { serial: '05', title: 'Notice', desc: '#注意事項#', thumbnail: '', href: '' },
  { serial: '06', title: 'Notice?', desc: '#注意事項?#', thumbnail: '', href: '' },
  { serial: '07', title: 'Setting', desc: '#背景故事#', thumbnail: '', href: '' },
  { serial: '08', title: 'Setting', desc: '#背景故事#', thumbnail: '', href: '' },
  { serial: '09', title: 'Hello', desc: '#你好#', thumbnail: '', href: '' },
  { serial: '10', title: 'Download', desc: '#下載#', thumbnail: '', href: 'https://drive.google.com/drive/folders/1jE7NwEJCSxSorq2Wr48uzqpLtjIyDhjF?usp=drive_link' },
